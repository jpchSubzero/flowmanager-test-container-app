...
using Eva.Insurtech.FlowManager.MultiTenancy;
...
namespace Eva.Insurtech.FlowManager
{
    ...
    public class FlowManagerIdentityServerModule : AbpModule
    {
        public override void ConfigureServices(ServiceConfigurationContext context)
        {
            ...
            if (!hostingEnvironment.IsDevelopment())
            {
                ...
                context.Services
                    .AddDataProtection()
                    .PersistKeysToStackExchangeRedis(redis, "FlowManager-Protection-Keys");
            }
