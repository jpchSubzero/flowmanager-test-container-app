...
namespace Eva.Insurtech.FlowManager.Migrations
{
    ...
    [Migration("20221220024651_pre-tracking-request-log-create")]
    partial class pretrackingrequestlogcreate
    {
                    ...
                    b.OwnsMany("Eva.Insurtech.FlowManagers.PreTrackings.PreTrackingSteps.PreTrackingStep", "PreTrackingSteps", b1 =>
                        {
                            ...
                            b1.HasKey("PreTrackingId", "RegisterDate");

                            b1.HasIndex("PreTrackingId", "RegisterDate")
                                .IsUnique();
                    ...
                    b.OwnsMany("Eva.Insurtech.FlowManagers.RequestLogs.Requests.Request", "Requests", b1 =>
                        {
                            ...
                            b1.HasKey("RequestLogId", "RegisterDate");

                            b1.HasIndex("RequestLogId", "RegisterDate")
                                .IsUnique();
