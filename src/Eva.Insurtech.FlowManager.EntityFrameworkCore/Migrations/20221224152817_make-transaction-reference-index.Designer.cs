...
namespace Eva.Insurtech.FlowManager.Migrations
{
    ...
    [Migration("20221224152817_make-transaction-reference-index")]
    partial class maketransactionreferenceindex
    {
                    ...
                    b.OwnsMany("Eva.Insurtech.FlowManagers.RequestLogs.Requests.Request", "Requests", b1 =>
                        {
                            ...
                            b1.HasKey("RequestLogId", "Service");

                            b1.HasIndex("RequestLogId", "Service")
                                .IsUnique();
